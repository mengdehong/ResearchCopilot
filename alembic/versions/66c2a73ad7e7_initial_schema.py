...
import pgvector.sqlalchemy.vector  # noqa: F401 — autogenerate 引用
...
def upgrade() -> None:
    ...
    op.create_table('section_headings',
    sa.Column('document_id', sa.UUID(), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['documents.id'], ),
    sa.ForeignKeyConstraint(['parent_id'], ['section_headings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
